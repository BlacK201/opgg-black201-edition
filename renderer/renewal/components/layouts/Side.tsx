...
const Side = () => {
  ...
  useEffect(() => {
    ...
    let checkTFT = () => {
      axios.get(`https://desktop-app-data.s3.ap-northeast-2.amazonaws.com/tft/7.5/recommend_test.json?timestamp=${new Date().getTime()}`).then((res) => {
      ...
      <div className="side-main">
        ...
        <ul className="side-menu">
          <li className="side-menu-item" style={{cursor: "pointer", display: "flex", alignItems: "center"}} onClick={() => dispatch(setIsSettingOpen(true))}>
            ...
            {(overlaySetting && (localStorage.getItem("isOverlay2") === "false" || localStorage.getItem("isOverlay2") === null)) &&
                <div style={{
                  display: "flex",
                  justifyContent: "center",
                  alignItems: "center",
