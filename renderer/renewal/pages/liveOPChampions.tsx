...
const LiveOPChampions = () => {
    ...
    useEffect(() => {
        if (!data) {
            axios.get(`https://desktop-app-data.op.gg/analytics/${region}/champion_stats.json`).then((res) => {
                setData(res.data);
            }).catch(() => {
                axios.get(`https://desktop-app-data.op.gg/analytics/KR/champion_stats.json`).then((res) => {
                    setData(res.data);
                });
            });

            axios.get(`https://desktop-app-data.op.gg/analytics/${region}/duo_stats_small.json`).then((res) => {
                setDuoData(res.data);
            }).catch(() => {
                axios.get(`https://desktop-app-data.op.gg/analytics/KR/duo_stats_small.json`).then((res) => {
                    setData(res.data);
                });
            });
        }
